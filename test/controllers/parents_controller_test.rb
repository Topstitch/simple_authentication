...
class ParentsControllerTest < ActionController::TestCase
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post :create, parent: { child: @parent.child, email: @parent.email, name: @parent.name, teacher_id: @parent.teacher_id }
    end
  ...
  test "should update parent" do
    patch :update, id: @parent, parent: { child: @parent.child, email: @parent.email, name: @parent.name, teacher_id: @parent.teacher_id }
    assert_redirected_to parent_path(assigns(:parent))
  end
